...
export default function AddHospitalApp({ onClose, onAppointmentAdded, hospitalId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await api.post(
                `/api/hospital/dashboard/generate-hospital-appointments/${hospitalId}`,
                submitData
            );
            ...
            if (error.response?.status === 422 && error.response?.data?.errors) {
                ...
                setErrors({
                    general: error.response?.data?.message || error.message || 'Failed to create hospital appointment'
                });
            }
        } finally {
            setLoading(false);
                ...
                {showSuccess && (
                    <div className="success-overlay">
                        <div className="success-check">
                            ...
                            <div className="success-text">Hospital Appointment created successfully</div>
                        </div>
                    </div>
                )}
                {!loading ? (
                    <>
                        <div className="modal-title">
                            <h2>Add New Hospital Appointment</h2>
                    ...
                    <div className="loader">
                        ...
                        <h3>Creating Hospital Appointment...</h3>
                    </div>
                )}
            </div>
        </section>
