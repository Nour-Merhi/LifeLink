...
export default function AddUrgentHospitalApp({ onClose, onAppointmentAdded, hospitalId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("❌ Error creating urgent hospital appointment:", error);
            ...
            {showSuccess && (
                <div className="success-overlay">
                    <div className="success-check">
                        ...
                        <div className="success-text">Urgent hospital appointment created successfully</div>
                    </div>
                </div>
            )}
            {!loading ? ( <>
                    <div className="modal-title">
                        <h2>Add New Urgent Hospital Request</h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-actions">
                                <button type="submit" className="submit-btn">
                                    Create Urgent Hospital Request
                                </button>
                            </div>
                        </form>
                    </div>
