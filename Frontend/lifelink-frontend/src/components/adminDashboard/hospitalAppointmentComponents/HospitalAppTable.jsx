...
import HospitalCalendarView from "../homeVisitComponents/HospitalCalendarView";
import EditAppointmentModal from "../homeVisitComponents/EditAppointmentModal";

export default function HospitalAppTable({ appointments = [], loading = false, error = "", onAppointmentsUpdate }){
    ...
    if (loading) {
        return (
            <div className="loader">
                ...
                <h3>Loading Hospital Visit Appointments...</h3>
            </div>
        );
    }
